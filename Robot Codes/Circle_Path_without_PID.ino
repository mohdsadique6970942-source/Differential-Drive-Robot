...
void setup() {
  ...
  Serial.println("time,yaw,totalYaw,yawRate,error,leftSpeed,rightSpeed");
...
void loop() {
  ...
  float actualYawRate = (dt > 0) ? (yawDelta / dt) : 0;

  float error = 40.0f - actualYawRate;   
  ...
  Serial.print(yaw, 2);
  Serial.print(",");
  Serial.print(totalYaw, 2);
  Serial.print(",");
  Serial.print(actualYawRate, 2);
  Serial.print(",");
